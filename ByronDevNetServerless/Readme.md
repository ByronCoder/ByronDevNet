...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ByronDevNetServerless*):

Restore dependencies
```
    cd "ByronDevNetServerless"
    dotnet restore
```

Execute unit tests
```
    cd "ByronDevNetServerless/test/ByronDevNetServerless.Tests"
    dotnet test
```

Deploy application
```
    cd "ByronDevNetServerless/src/ByronDevNetServerless"
